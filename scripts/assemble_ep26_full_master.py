#!/usr/bin/env python3
"""
HUURS STUDIO - Episode 26 Full Master Assembly (Season 4 Premiere)
==================================================================
Assembles all 5 verified 720p HD curated scene clips for Episode 26 (Surah Ash-Shu'ara 26:63, 78–82, 88–89, 217)
...
- Section 1: Shoreline Vista at Dawn (EP02_SCENE05.mp4 - Ayah 26:63)
- Section 2: Olive Leaves & Reviving Rain (EP02_SCENE03.mp4 - Ayah 26:7)
- Section 3: Enduring Mountain Olive Tree (EP05_SCENE03.mp4 - Ayah 26:78–82)
- Section 4: Single Leaf on Crystal Water (ep24_scene03.mp4 - Ayah 26:88–89)
- Section 5: Sacred Scripture in Rain Sanctuary (EP02_SCENE01.mp4 - Ayah 26:217)
...
AUDIO_IN = os.path.join(ROOT_DIR, "11_AUDIO/EP26_audio.mp3")
TIMINGS_JSON = os.path.join(ROOT_DIR, "11_AUDIO/EP26_audio_timings.json")
OUTPUT_MASTER = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP26-FULL-MASTER.mp4")
OUTPUT_SHORT = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP26-SHORT-001A.mp4")
TEMP_DIR = "/tmp/ep26_assembly"

os.makedirs(TEMP_DIR, exist_ok=True)

S1_FILE = os.path.join(RENDERS_DIR, "EP02_SCENE05.mp4")
S2_FILE = os.path.join(RENDERS_DIR, "EP02_SCENE03.mp4")
S3_FILE = os.path.join(RENDERS_DIR, "EP05_SCENE03.mp4")
S4_FILE = os.path.join(RENDERS_DIR, "ep24_scene03.mp4")
S5_FILE = os.path.join(RENDERS_DIR, "EP02_SCENE01.mp4")

DEFAULT_SECTIONS = [
    {"id": "sec1", "file": S1_FILE, "name": "Shoreline Vista at Dawn", "duration": 45.0},
    {"id": "sec2", "file": S2_FILE, "name": "Olive Leaves & Reviving Rain", "duration": 45.0},
    {"id": "sec3", "file": S3_FILE, "name": "Enduring Mountain Olive Tree", "duration": 45.0},
    {"id": "sec4", "file": S4_FILE, "name": "Single Leaf on Crystal Water", "duration": 45.0},
    {"id": "sec5", "file": S5_FILE, "name": "Sacred Scripture in Rain Sanctuary", "duration": 30.0},
]
...
def assemble_master(sections):
    ...
    print("=" * 70)
    print(f"HUURS STUDIO - ASSEMBLING EPISODE 26 FULL MASTER ({total_dur:.2f}s)")
    print("=" * 70)
    ...
    print("\nRendering 9:16 Vertical Short from Section 1 (The Sea of Certainty)...")
