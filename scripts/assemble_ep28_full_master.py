#!/usr/bin/env python3
"""
HUURS STUDIO - Episode 28 Full Master Assembly (Season 4)
=========================================================
Assembles all 5 verified 720p HD curated scene clips for Episode 28 (Surah Al-Qasas 28:7, 24, 30, 76–77, 88)
...
- Section 1: Rain in Stone Basin & Surrendered Cradle (Rain_falling_on_stone_basin... - Ayah 28:7)
- Section 2: Mountain Trail into Madyan Valley (EP04_SCENE03.mp4 - Ayah 28:24)
- Section 3: Ancient Olive Grove & Blessed Valley (Stone_pathway_through_olive_grove... - Ayah 28:30)
- Section 4: Golden Dunes & Transience of Worldly Wealth (EP05_SCENE05.mp4 - Ayah 28:76–77)
- Section 5: Sacred Manuscript & The Eternal Face (EP04_SCENE02.mp4 - Ayah 28:88)
...
AUDIO_IN = os.path.join(ROOT_DIR, "11_AUDIO/EP28_audio.mp3")
TIMINGS_JSON = os.path.join(ROOT_DIR, "11_AUDIO/EP28_audio_timings.json")
OUTPUT_MASTER = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP28-FULL-MASTER.mp4")
OUTPUT_SHORT = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP28-SHORT-001A.mp4")
TEMP_DIR = "/tmp/ep28_assembly"

os.makedirs(TEMP_DIR, exist_ok=True)

S1_FILE = os.path.join(RENDERS_DIR, "Rain_falling_on_stone_basin_20260910203041.mp4")
S2_FILE = os.path.join(RENDERS_DIR, "EP04_SCENE03.mp4")
S3_FILE = os.path.join(RENDERS_DIR, "Stone_pathway_through_olive_grove_202609080940.mp4")
S4_FILE = os.path.join(RENDERS_DIR, "EP05_SCENE05.mp4")
S5_FILE = os.path.join(RENDERS_DIR, "EP04_SCENE02.mp4")

DEFAULT_SECTIONS = [
    {"id": "sec1", "file": S1_FILE, "name": "Rain in Stone Basin & Surrendered Cradle", "duration": 45.0},
    {"id": "sec2", "file": S2_FILE, "name": "Mountain Trail into Madyan Valley", "duration": 45.0},
    {"id": "sec3", "file": S3_FILE, "name": "Ancient Olive Grove & Blessed Valley", "duration": 45.0},
    {"id": "sec4", "file": S4_FILE, "name": "Golden Dunes & Transience of Wealth", "duration": 45.0},
    {"id": "sec5", "file": S5_FILE, "name": "Sacred Manuscript & The Eternal Face", "duration": 30.0},
]
...
def assemble_master(sections):
    ...
    print("\nRendering 9:16 Vertical Short from Section 1 (Rain in Stone Basin)...")
