#!/usr/bin/env python3
"""
HUURS STUDIO - Episode 23 Full Master Assembly (Season 3)
=========================================================
Assembles all 5 verified 720p HD scene clips for Episode 23 (Surah Al-Mu'minun 23:1–2, 20)
...
- Section 1: Autumn Wind Scattering Dry Leaves Across Slate (ep23_scene01.mp4)
- Section 2: Ancient Gnarled Olive Tree of Sinai Rooted in Rock (ep23_scene02.mp4)
- Section 3: Pure Golden Virgin Olive Oil Flowing into Stone Bowl (ep23_scene03.mp4)
- Section 4: Single Olive Leaf Landing on Mirror-Still Spring Water (ep23_scene04.mp4)
- Section 5: Natural Woven Prayer Mat on Stone Veranda at Dawn (ep23_scene05.mp4)
...
AUDIO_IN = os.path.join(ROOT_DIR, "11_AUDIO/EP23_audio.mp3")
TIMINGS_JSON = os.path.join(ROOT_DIR, "11_AUDIO/EP23_audio_timings.json")
OUTPUT_MASTER = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP23-FULL-MASTER.mp4")
OUTPUT_SHORT = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP23-SHORT-001A.mp4")
TEMP_DIR = "/tmp/ep23_assembly"

os.makedirs(TEMP_DIR, exist_ok=True)

S1_FILE = os.path.join(RENDERS_DIR, "ep23_scene01.mp4")
S2_FILE = os.path.join(RENDERS_DIR, "ep23_scene02.mp4")
S3_FILE = os.path.join(RENDERS_DIR, "ep23_scene03.mp4")
S4_FILE = os.path.join(RENDERS_DIR, "ep23_scene04.mp4")
S5_FILE = os.path.join(RENDERS_DIR, "ep23_scene05.mp4")

DEFAULT_SECTIONS = [
    {"id": "sec1", "file": S1_FILE, "name": "Autumn Wind Scattering Leaves", "duration": 45.0},
    {"id": "sec2", "file": S2_FILE, "name": "Ancient Olive Tree of Sinai", "duration": 60.0},
    {"id": "sec3", "file": S3_FILE, "name": "Pure Olive Oil Pouring into Bowl", "duration": 60.0},
    {"id": "sec4", "file": S4_FILE, "name": "Olive Leaf on Still Spring Water", "duration": 35.0},
    {"id": "sec5", "file": S5_FILE, "name": "Prayer Mat on Stone Porch at Dawn", "duration": 30.0},
]
...
def assemble_master(sections):
    ...
    print("=" * 70)
    print(f"HUURS STUDIO - ASSEMBLING EPISODE 23 FULL MASTER ({total_dur:.2f}s)")
    print("=" * 70)
    ...
    print(f"✓ EPISODE 23 FULL MASTER COMPLETED in {time.time()-t0:.2f}s!")
...
def assemble_short(sections):
    ...
    print("-" * 70)
    print(f"Assembling 9:16 Vertical Cut (Short A: The Scattered Mind, {dur:.2f}s)...")
    ...
    if res.returncode != 0:
        ...
        sys.exit(1)
    print(f"✓ EPISODE 23 SHORT 001A COMPLETED!")
