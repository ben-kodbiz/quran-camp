#!/usr/bin/env python3
"""
HUURS STUDIO - Episode 25 Full Master Assembly (Season 3 Finale)
================================================================
Assembles all 5 verified 720p HD curated scene clips for Episode 25 (Surah Al-Furqan 25:48, 53, 61, 63, 74)
...
- Section 1: Pure Rain Descending on Stone Basin (Rain_falling_on_stone_basin_20260910203041.mp4 - Ayah 25:48)
- Section 2: Confluence of Waters with Sea Mist (Ocean_dawn_with_sea_mist_20260910201340.mp4 - Ayah 25:53)
- Section 3: Vast Heavens & Sunrise Over Sanctuary (EP02_SCENE02.mp4 - Ayah 25:61)
- Section 4: Ancient Pathway Winding into Green Valley (EP04_SCENE03.mp4 - Ayah 25:63)
- Section 5: Sacred Scripture in Peaceful Alcove (EP04_SCENE02.mp4 - Ayah 25:74)
...
AUDIO_IN = os.path.join(ROOT_DIR, "11_AUDIO/EP25_audio.mp3")
TIMINGS_JSON = os.path.join(ROOT_DIR, "11_AUDIO/EP25_audio_timings.json")
OUTPUT_MASTER = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP25-FULL-MASTER.mp4")
OUTPUT_SHORT = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP25-SHORT-001A.mp4")
TEMP_DIR = "/tmp/ep25_assembly"

os.makedirs(TEMP_DIR, exist_ok=True)

S1_FILE = os.path.join(RENDERS_DIR, "Rain_falling_on_stone_basin_20260910203041.mp4")
S2_FILE = os.path.join(RENDERS_DIR, "Ocean_dawn_with_sea_mist_20260910201340.mp4")
S3_FILE = os.path.join(RENDERS_DIR, "EP02_SCENE02.mp4")
S4_FILE = os.path.join(RENDERS_DIR, "EP04_SCENE03.mp4")
S5_FILE = os.path.join(RENDERS_DIR, "EP04_SCENE02.mp4")

DEFAULT_SECTIONS = [
    {"id": "sec1", "file": S1_FILE, "name": "Pure Rain on Stone Basin", "duration": 40.91},
    {"id": "sec2", "file": S2_FILE, "name": "Confluence of Waters & Sea Mist", "duration": 47.96},
    {"id": "sec3", "file": S3_FILE, "name": "Heavens & Sanctuary Dawn", "duration": 43.27},
    {"id": "sec4", "file": S4_FILE, "name": "Dignified Pathway to Green Valley", "duration": 31.19},
    {"id": "sec5", "file": S5_FILE, "name": "Open Scripture in Sacred Alcove", "duration": 15.91},
]
...
def assemble_master(sections):
    ...
    print("=" * 70)
    print(f"HUURS STUDIO - ASSEMBLING EPISODE 25 FULL MASTER ({total_dur:.2f}s)")
    print("=" * 70)
    ...
    print("\nRendering 9:16 Vertical Short from Section 1 (Pure Rain on Stone Basin)...")
