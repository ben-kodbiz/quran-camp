#!/usr/bin/env python3
"""
HUURS STUDIO - Episode 22 Full Master Assembly (Season 3)
=========================================================
Assembles all 5 verified 720p HD scene clips for Episode 22 (Surah Al-Hajj 22:5, 27)
...
- Section 1: Parched Cracked Soil under Desert Heat Haze (ep22_scene01.mp4)
- Section 2: Heavy Rain Drops Impacting Cracked Soil / Earth Quivers (ep22_scene02.mp4)
- Section 3: Winding Mountain Trail in Sandstone Canyons / The Call (ep22_scene03.mp4)
- Section 4: 100mm Macro of Common Fly / The Parable of Creation (ep22_scene04.mp4)
- Section 5: Quiet Stone Fountain Basin at Dawn / The Living Return (ep22_scene05.mp4)
...
AUDIO_IN = os.path.join(ROOT_DIR, "11_AUDIO/EP22_audio.mp3")
TIMINGS_JSON = os.path.join(ROOT_DIR, "11_AUDIO/EP22_audio_timings.json")
OUTPUT_MASTER = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP22-FULL-MASTER.mp4")
OUTPUT_SHORT = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP22-SHORT-001A.mp4")
TEMP_DIR = "/tmp/ep22_assembly"

os.makedirs(TEMP_DIR, exist_ok=True)

S1_FILE = os.path.join(RENDERS_DIR, "ep22_scene01.mp4")
S2_FILE = os.path.join(RENDERS_DIR, "ep22_scene02.mp4")
S3_FILE = os.path.join(RENDERS_DIR, "ep22_scene03.mp4")
S4_FILE = os.path.join(RENDERS_DIR, "ep22_scene04.mp4")
S5_FILE = os.path.join(RENDERS_DIR, "ep22_scene05.mp4")

DEFAULT_SECTIONS = [
    {"id": "sec1", "file": S1_FILE, "name": "Parched Cracked Soil in Desert", "duration": 45.0},
    {"id": "sec2", "file": S2_FILE, "name": "Heavy Rain Impacts & Quivering Soil", "duration": 60.0},
    {"id": "sec3", "file": S3_FILE, "name": "Winding Mountain Trail in Sandstone Canyons", "duration": 60.0},
    {"id": "sec4", "file": S4_FILE, "name": "Macro Fly / Parable of Creation", "duration": 35.0},
    {"id": "sec5", "file": S5_FILE, "name": "Quiet Courtyard Basin at Dawn", "duration": 30.0},
]
...
def assemble_master(sections):
    ...
    print("=" * 70)
    print(f"HUURS STUDIO - ASSEMBLING EPISODE 22 FULL MASTER ({total_dur:.2f}s)")
    print("=" * 70)
    ...
    print(f"✓ EPISODE 22 FULL MASTER COMPLETED in {time.time()-t0:.2f}s!")
...
def assemble_short(sections):
    ...
    print("-" * 70)
    print(f"Assembling 9:16 Vertical Cut (Short A: The Cracked Soil, {dur:.2f}s)...")
    ...
    if res.returncode != 0:
        ...
        sys.exit(1)
    print(f"✓ EPISODE 22 SHORT 001A COMPLETED!")
