#!/usr/bin/env python3
"""
HUURS STUDIO - Episode 27 Full Master Assembly (Season 4)
=========================================================
Assembles all 5 verified 720p HD curated scene clips for Episode 27 (Surah An-Naml 27:16–19, 60, 62, 88, 93)
...
- Section 1: Rainforest Bird in Mountain Mist (EP09_SCENE04.mp4 - Ayah 27:16, 19)
- Section 2: Courtyard Fountain & Gardens of Delight (EP04_SCENE05.mp4 - Ayah 27:60)
- Section 3: Mountains Drifting Like Clouds (EP09_SCENE05.mp4 - Ayah 27:88)
- Section 4: Mountain Stream & Desperate Caller (Mountain_stream_flowing_over_stones... - Ayah 27:62)
- Section 5: Golden Sunrise Over Coastal Waves (Sunrise_over_ocean_coastline... - Ayah 27:93)
...
AUDIO_IN = os.path.join(ROOT_DIR, "11_AUDIO/EP27_audio.mp3")
TIMINGS_JSON = os.path.join(ROOT_DIR, "11_AUDIO/EP27_audio_timings.json")
OUTPUT_MASTER = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP27-FULL-MASTER.mp4")
OUTPUT_SHORT = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP27-SHORT-001A.mp4")
TEMP_DIR = "/tmp/ep27_assembly"

os.makedirs(TEMP_DIR, exist_ok=True)

S1_FILE = os.path.join(RENDERS_DIR, "EP09_SCENE04.mp4")
S2_FILE = os.path.join(RENDERS_DIR, "EP04_SCENE05.mp4")
S3_FILE = os.path.join(RENDERS_DIR, "EP09_SCENE05.mp4")
S4_FILE = os.path.join(RENDERS_DIR, "Mountain_stream_flowing_over_stones_202609080917.mp4")
S5_FILE = os.path.join(RENDERS_DIR, "Sunrise_over_ocean_coastline_20260910203049.mp4")

DEFAULT_SECTIONS = [
    {"id": "sec1", "file": S1_FILE, "name": "Rainforest Bird in Mountain Mist", "duration": 45.0},
    {"id": "sec2", "file": S2_FILE, "name": "Courtyard Fountain & Gardens of Delight", "duration": 45.0},
    {"id": "sec3", "file": S3_FILE, "name": "Mountains Drifting Like Clouds", "duration": 45.0},
    {"id": "sec4", "file": S4_FILE, "name": "Mountain Stream & Desperate Caller", "duration": 45.0},
    {"id": "sec5", "file": S5_FILE, "name": "Golden Sunrise Over Coastal Waves", "duration": 30.0},
]
...
def assemble_master(sections):
    ...
    print("=" * 70)
    print(f"HUURS STUDIO - ASSEMBLING EPISODE 27 FULL MASTER ({total_dur:.2f}s)")
    print("=" * 70)
    ...
    print("\nRendering 9:16 Vertical Short from Section 1 (Rainforest Bird in Mountain Mist)...")
