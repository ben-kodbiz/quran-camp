#!/usr/bin/env python3
"""
HUURS STUDIO - Episode 17 Full Master Assembly (Season 2)
=========================================================
Assembles all 5 living-creation scene clips for Episode 17 (Surah Al-Isra 17:23–24, 79, 82)
...
- Section 1: Calm Mountain Lake at Twilight Reflecting Stars (The Sharp Tongue at Home)
- Section 2: Infinite Spiral Galaxy & Celestial Cosmos (The Sacred Charter of Parents)
- Section 3: Noble Arabian Horse in Dewy Palm Oasis (The Prohibition of a Sigh)
- Section 4: Bird of Paradise Cenderawasih in Emerald Canopy (The Sanctuary of Tahajjud & Shifa')
- Section 5: Masjid an-Nabawi Sunrise Sanctuary Arches (The Lowered Wing Call)
...
AUDIO_IN = os.path.join(ROOT_DIR, "11_AUDIO/EP17_audio.mp3")
TIMINGS_JSON = os.path.join(ROOT_DIR, "11_AUDIO/EP17_audio_timings.json")
OUTPUT_MASTER = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP17-FULL-MASTER.mp4")
OUTPUT_SHORT = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP17-SHORT-001A.mp4")
TEMP_DIR = "/tmp/ep17_assembly"

os.makedirs(TEMP_DIR, exist_ok=True)

S1_FILE = os.path.join(RENDERS_DIR, "EP17_SCENE01.mp4")
S2_FILE = os.path.join(RENDERS_DIR, "EP17_SCENE02.mp4")
S3_FILE = os.path.join(RENDERS_DIR, "EP17_SCENE03.mp4")
S4_FILE = os.path.join(RENDERS_DIR, "EP17_SCENE04.mp4")
S5_FILE = os.path.join(RENDERS_DIR, "EP17_SCENE05.mp4")

DEFAULT_SECTIONS = [
    {"id": "sec1", "file": S1_FILE, "name": "Calm Mountain Lake at Twilight", "duration": 40.0},
    {"id": "sec2", "file": S2_FILE, "name": "Infinite Spiral Galaxy & Cosmos", "duration": 48.0},
    {"id": "sec3", "file": S3_FILE, "name": "Noble Arabian Horse in Oasis", "duration": 52.0},
    {"id": "sec4", "file": S4_FILE, "name": "Bird of Paradise Cenderawasih", "duration": 44.0},
    {"id": "sec5", "file": S5_FILE, "name": "Masjid an-Nabawi Sunrise Arches", "duration": 40.0},
]
...
def assemble_master(sections):
    ...
    print("=" * 70)
    print(f"HUURS STUDIO - ASSEMBLING EPISODE 17 FULL MASTER ({total_dur:.2f}s)")
    print("=" * 70)
    ...
    print(f"✓ EPISODE 17 FULL MASTER COMPLETED in {time.time()-t0:.2f}s!")
...
def assemble_short(sections):
    ...
    dur = sec1["duration"]
    print("-" * 70)
    print(f"Assembling 9:16 Vertical Cut (Short A: The Sharp Tongue at Home, {dur:.2f}s)...")
    ...
    if res.returncode != 0:
        ...
        sys.exit(1)
    print(f"✓ EPISODE 17 SHORT 001A COMPLETED!")
