#!/usr/bin/env python3
"""
HUURS STUDIO - Episode 24 Full Master Assembly (Season 3)
=========================================================
Assembles all 5 verified 720p HD curated scene clips for Episode 24 (Surah An-Nur 24:35, 39–41)
...
- Section 1: Midnight Ocean of Layered Darkness (ep24_scene01_stormy_ocean.mp4 - Ayah 24:40)
- Section 2: Desert Dunes & Heat Shimmer Mirage (EP05_SCENE05.mp4 - Ayah 24:39)
- Section 3: Volumetric Sunbeams Through Mosque Stone Arches (Sunbeams_through_mosque_stone_ar... - Ayah 24:35)
- Section 4: Pure Doves Gliding Over Mountain Mist Waterfall (Birds_gliding_over_waterfall... - Ayah 24:41)
- Section 5: Expansive Ocean Waves at Golden Dawn (EP02_SCENE-04.mp4 - Ayah 24:35)
...
AUDIO_IN = os.path.join(ROOT_DIR, "11_AUDIO/EP24_audio.mp3")
TIMINGS_JSON = os.path.join(ROOT_DIR, "11_AUDIO/EP24_audio_timings.json")
OUTPUT_MASTER = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP24-FULL-MASTER.mp4")
OUTPUT_SHORT = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP24-SHORT-001A.mp4")
TEMP_DIR = "/tmp/ep24_assembly"

os.makedirs(TEMP_DIR, exist_ok=True)

S1_FILE = os.path.join(RENDERS_DIR, "ep24_scene01_stormy_ocean.mp4")
S2_FILE = os.path.join(RENDERS_DIR, "EP05_SCENE05.mp4")
S3_FILE = os.path.join(RENDERS_DIR, "Sunbeams_through_mosque_stone_ar…_20260910203025.mp4")
S4_FILE = os.path.join(RENDERS_DIR, "Birds_gliding_over_waterfall_20260910203353.mp4")
S5_FILE = os.path.join(RENDERS_DIR, "EP02_SCENE-04.mp4")

DEFAULT_SECTIONS = [
    {"id": "sec1", "file": S1_FILE, "name": "Ocean of Layered Darkness", "duration": 45.0},
    {"id": "sec2", "file": S2_FILE, "name": "Desert Mirage of the Thirsty Soul", "duration": 60.0},
    {"id": "sec3", "file": S3_FILE, "name": "Niche of Light & Sunbeams in Sanctuary", "duration": 60.0},
    {"id": "sec4", "file": S4_FILE, "name": "Praise of Birds with Wings Outspread", "duration": 35.0},
    {"id": "sec5", "file": S5_FILE, "name": "Light Upon Light Golden Dawn Return", "duration": 30.0},
]
...
def assemble_master(sections):
    ...
    print("=" * 70)
    print(f"HUURS STUDIO - ASSEMBLING EPISODE 24 FULL MASTER ({total_dur:.2f}s)")
    print("=" * 70)
    ...
    print("\nRendering 9:16 Vertical Short from Section 1 (Ocean of Layered Darkness)...")
