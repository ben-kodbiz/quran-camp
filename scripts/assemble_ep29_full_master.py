#!/usr/bin/env python3
"""
HUURS STUDIO - Episode 29 Full Master Assembly (Season 4)
=========================================================
Assembles all 5 verified 720p HD curated scene clips for Episode 29 (Surah Al-Ankabut 29:2, 41, 60, 69, 45)
...
- Section 1: Mountain Ridge Pathway & Crucible of Trials (Rain_falling_on_stone_basin... - Ayah 28:7)
- Section 2: Sandstone Monument & Spider House (EP08_SCENE05.mp4 - Ayah 28:24)
- Section 3: Deep Azure Ocean & Effortless Sustenance (Stone_pathway_through_olive_grove... - Ayah 28:30)
- Section 4: Golden Dunes & Transience of Worldly Wealth (ep21_scene03.mp4 - Ayah 28:76–77)
- Section 5: White Marble Colonnades of Remembrance (EP07_SCENE05.mp4 - Ayah 28:88)
...
AUDIO_IN = os.path.join(ROOT_DIR, "11_AUDIO/EP29_audio.mp3")
TIMINGS_JSON = os.path.join(ROOT_DIR, "11_AUDIO/EP29_audio_timings.json")
OUTPUT_MASTER = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP29-FULL-MASTER.mp4")
OUTPUT_SHORT = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP29-SHORT-001A.mp4")
TEMP_DIR = "/tmp/ep29_assembly"

os.makedirs(TEMP_DIR, exist_ok=True)

S1_FILE = os.path.join(RENDERS_DIR, "Mountain_pathway_winding_upward_…_202609080942.mp4")
S2_FILE = os.path.join(RENDERS_DIR, "EP08_SCENE05.mp4")
S3_FILE = os.path.join(RENDERS_DIR, "EP09_SCENE02.mp4")
S4_FILE = os.path.join(RENDERS_DIR, "ep21_scene03.mp4")
S5_FILE = os.path.join(RENDERS_DIR, "EP07_SCENE05.mp4")

DEFAULT_SECTIONS = [
    {"id": "sec1", "file": S1_FILE, "name": "Mountain Ridge Pathway & Crucible of Trials", "duration": 45.0},
    {"id": "sec2", "file": S2_FILE, "name": "Sandstone Monument & Spider House", "duration": 45.0},
    {"id": "sec3", "file": S3_FILE, "name": "Deep Azure Ocean & Effortless Sustenance", "duration": 45.0},
    {"id": "sec4", "file": S4_FILE, "name": "Misty Pine Forest & Guiding the Striving", "duration": 45.0},
    {"id": "sec5", "file": S5_FILE, "name": "White Marble Colonnades of Remembrance", "duration": 30.0},
]
...
def assemble_master(sections):
    ...
    print("\nRendering 9:16 Vertical Short from Section 1 (Crucible of Trials)...")
