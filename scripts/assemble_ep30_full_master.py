#!/usr/bin/env python3
"""
HUURS STUDIO - Episode 30 Full Master Assembly (Season 4)
=========================================================
Assembles all 5 verified 720p HD curated scene clips for Episode 30 (Surah Ar-Rum 30:41, 22, 24, 46, 30)
...
- Section 1: Autumn Gale & Ecological Discord (Rain_falling_on_stone_basin... - Ayah 28:7)
- Section 2: Colossal Clouds & Cosmic Diversity (EP04_SCENE04.mp4 - Ayah 28:24)
- Section 3: Ancient Pathway & Rain of Revival (Stone_pathway_through_olive_grove... - Ayah 28:30)
- Section 4: Golden Dunes & Transience of Worldly Wealth (EP06_SCENE05.mp4 - Ayah 28:76–77)
- Section 5: Sacred Manuscript & Primordial Fitrah (ep21_scene05.mp4 - Ayah 28:88)
...
AUDIO_IN = os.path.join(ROOT_DIR, "11_AUDIO/EP30_audio.mp3")
TIMINGS_JSON = os.path.join(ROOT_DIR, "11_AUDIO/EP30_audio_timings.json")
OUTPUT_MASTER = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP30-FULL-MASTER.mp4")
OUTPUT_SHORT = os.path.join(RENDERS_DIR, "QURAN-COMEBACK-EP30-SHORT-001A.mp4")
TEMP_DIR = "/tmp/ep30_assembly"

os.makedirs(TEMP_DIR, exist_ok=True)

S1_FILE = os.path.join(RENDERS_DIR, "ep23_scene01.mp4")
S2_FILE = os.path.join(RENDERS_DIR, "EP04_SCENE04.mp4")
S3_FILE = os.path.join(RENDERS_DIR, "EP06_SCENE01.mp4")
S4_FILE = os.path.join(RENDERS_DIR, "EP06_SCENE05.mp4")
S5_FILE = os.path.join(RENDERS_DIR, "ep21_scene05.mp4")

DEFAULT_SECTIONS = [
    {"id": "sec1", "file": S1_FILE, "name": "Autumn Gale & Ecological Discord", "duration": 45.0},
    {"id": "sec2", "file": S2_FILE, "name": "Colossal Clouds & Cosmic Diversity", "duration": 45.0},
    {"id": "sec3", "file": S3_FILE, "name": "Ancient Pathway & Rain of Revival", "duration": 45.0},
    {"id": "sec4", "file": S4_FILE, "name": "Ocean Sailing Vessel & Winds of Mercy", "duration": 45.0},
    {"id": "sec5", "file": S5_FILE, "name": "Sacred Manuscript & Primordial Fitrah", "duration": 30.0},
]
...
def assemble_master(sections):
    ...
    print("\nRendering 9:16 Vertical Short from Section 1 (Discord & Returning)...")
