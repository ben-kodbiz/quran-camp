#!/usr/bin/env python3
"""
Huurs Studio - Surah Al-Kahf Master Mindmap HTML & Markdown Generator
...
HTML_OUT = os.path.join(BASE_DIR, "KAHF_MASTER_MINDMAP.html")
MD_OUT = os.path.join(BASE_DIR, "KAHF_MASTER_MINDMAP.md")
PDF_SRC = os.path.join(BASE_DIR, "build_kahf_mindmap_pdf.py")
...
# ==========================================
md_lines = [
    "# Surah Al-Kahf Master Landscape Mindmap",
    "## 8 Landscape Plates • 16 Thematic Pillars • 64 Detailed Analytical Cards",
    "",
...
<head>
  ...
  <title>Surah Al-Kahf Master Landscape Mindmap | Huurs Studio</title>
  <style>
    :root {{
      --navy-deep: #060a12;
      --navy-card: #0d1422;
...
<body>
  <div class="wrapper">
    <header class="header">
      <div>
        <h1>HUURS STUDIO</h1>
        <span>Surah Al-Kahf Master Landscape Mindmap Cartography</span>
      </div>
