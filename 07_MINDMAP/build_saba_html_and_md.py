#!/usr/bin/env python3
"""
Huurs Studio - Surah Saba Master Mindmap HTML & Markdown Generator
...
HTML_OUT = os.path.join(BASE_DIR, "SABA_MASTER_MINDMAP.html")
MD_OUT = os.path.join(BASE_DIR, "SABA_MASTER_MINDMAP.md")
PDF_SRC = os.path.join(BASE_DIR, "build_saba_mindmap_pdf.py")
...
# Generate Markdown
md_lines = [
    "# Surah Saba: Master Mindmap Knowledge Architecture",
...
<head>
  ...
  <title>Surah Saba Master Mindmap • Huurs Studio</title>
  <style>
    :root {{
      --navy-deep: #060A12;
      --navy-card: #0D1422;
...
<body>
  <div class="wrapper">
    <header class="header">
      <div>
        <h1>SURAH SABA • MASTER MINDMAP ARCHITECTURE</h1>
        <span>8 Widescreen Plates • 16 Pillars • 64 Detailed Analytical Cards</span>
      </div>
      <div>
        <a href="SABA_MASTER_MINDMAP.pdf" target="_blank" style="background:var(--gold); color:var(--navy-deep); padding:8px 14px; border-radius:6px; font-weight:600; text-decoration:none; font-size:0.82rem;">Download Vector PDF ↗</a>
      </div>
    </header>
