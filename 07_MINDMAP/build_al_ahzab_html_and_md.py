#!/usr/bin/env python3
"""
Huurs Studio - Surah Al-Ahzab Master Mindmap HTML & Markdown Generator
...
HTML_OUT = os.path.join(BASE_DIR, "AL_AHZAB_MASTER_MINDMAP.html")
MD_OUT = os.path.join(BASE_DIR, "AL_AHZAB_MASTER_MINDMAP.md")
PDF_SRC = os.path.join(BASE_DIR, "build_al_ahzab_mindmap_pdf.py")
...
# Generate Markdown
md_lines = [
    "# Surah Al-Ahzab: Master Mindmap Knowledge Architecture",
...
<head>
  ...
  <title>Surah Al-Ahzab Master Mindmap • Huurs Studio</title>
  <style>
    :root {{
      --navy-deep: #060A12;
      --navy-card: #0D1422;
...
<body>
  <div class="wrapper">
    <header class="header">
      <h1>HUURS STUDIO</h1>
      <span>Surah Al-Ahzab Master Mindmap (8 Plates • 16 Pillars • 64 Cards)</span>
    </header>
