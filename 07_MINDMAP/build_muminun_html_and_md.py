#!/usr/bin/env python3
"""
Huurs Studio - Surah Al-Mu'minun Master Mindmap HTML & Markdown Generator
...
HTML_OUT = os.path.join(BASE_DIR, "MUMINUN_MASTER_MINDMAP.html")
MD_OUT = os.path.join(BASE_DIR, "MUMINUN_MASTER_MINDMAP.md")
PDF_SRC = os.path.join(BASE_DIR, "build_muminun_mindmap_pdf.py")
...
# ==========================================
md_lines = [
    "# Surah Al-Mu'minun Master Landscape Mindmap",
    "## 8 Landscape Plates • 16 Thematic Pillars • 64 Detailed Analytical Cards",
    "",
...
<head>
  ...
  <title>Surah Al-Mu'minun Master Landscape Mindmap | Huurs Studio</title>
  <style>
    :root {{
      --navy-deep: #060a12;
      --navy-card: #0d1422;
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .pillar.cyan h3 {{ color: var(--cyan); }}
    .pillar.purple h3 {{ color: var(--purple); }}
    .pillar.emerald h3 {{ color: var(--emerald); }}
    .pillar.gold h3 {{ color: var(--gold); }}
    .pillar.rose h3 {{ color: var(--rose); }}
    .pillar-header p {{
      font-size: 0.75rem;
      color: var(--text-muted);
    }}
...
<body>
  <div class="wrapper">
    <header class="header">
      <h1>HUURS STUDIO</h1>
      <span>Surah Al-Mu'minun Master Mindmap (8 Plates • 16 Pillars • 64 Cards)</span>
    </header>
    ...
    <footer class="footer">
      <p>Huurs Knowledge Systems • Sunni Source Discipline • Read. Reflect. Return.</p>
    </footer>
  </div>
