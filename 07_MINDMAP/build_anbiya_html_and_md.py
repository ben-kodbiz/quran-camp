#!/usr/bin/env python3
"""
Huurs Studio - Surah Al-Anbiya Master Mindmap HTML & Markdown Generator
...
HTML_OUT = os.path.join(BASE_DIR, "ANBIYA_MASTER_MINDMAP.html")
MD_OUT = os.path.join(BASE_DIR, "ANBIYA_MASTER_MINDMAP.md")
PDF_SRC = os.path.join(BASE_DIR, "build_anbiya_mindmap_pdf.py")
...
# ==========================================
md_lines = [
    "# Surah Al-Anbiya Master Landscape Mindmap",
    "## 8 Landscape Plates • 16 Thematic Pillars • 64 Detailed Analytical Cards",
    "",
...
<head>
  ...
  <title>Surah Al-Anbiya Master Landscape Mindmap | Huurs Studio</title>
  <style>
    :root {{
      --navy-deep: #060a12;
      --navy-card: #0d1422;
...
<body>
  <div class="wrapper">
    <header class="header">
      <h1>HUURS STUDIO</h1>
      <span>Surah Al-Anbiya Master Mindmap (8 Plates • 16 Pillars • 64 Cards)</span>
    </header>
