#!/usr/bin/env python3
"""
Huurs Studio - Surah Ar-Ra'd Master Mindmap HTML & Markdown Generator
...
HTML_OUT = os.path.join(BASE_DIR, "RAD_MASTER_MINDMAP.html")
MD_OUT = os.path.join(BASE_DIR, "RAD_MASTER_MINDMAP.md")
PDF_SRC = os.path.join(BASE_DIR, "build_rad_mindmap_pdf.py")
...
# Generate Markdown
md_lines = [
    "# Surah Ar-Ra'd — Master Landscape Mindmap Documentation",
    "## 8 Landscape Plates • 16 Thematic Pillars • 64 Detailed Analytical Cards",
    "",
...
<head>
  ...
  <title>Surah Ar-Ra'd Master Landscape Mindmap | Huurs Studio</title>
  <style>
    :root {{
      --navy-deep: #060a12;
      --navy-card: #0d1422;
...
<body>
  <div class="wrapper">
    <header class="header">
      <div>
        <h1>HUURS STUDIO</h1>
        <span>Surah Ar-Ra'd Master Landscape Mindmap Cartography</span>
      </div>
