#!/usr/bin/env python3
"""
Huurs Studio - Surah An-Nur Master Mindmap HTML & Markdown Generator
...
HTML_OUT = os.path.join(BASE_DIR, "NUR_MASTER_MINDMAP.html")
MD_OUT = os.path.join(BASE_DIR, "NUR_MASTER_MINDMAP.md")
PDF_SRC = os.path.join(BASE_DIR, "build_nur_mindmap_pdf.py")
...
# ==========================================
md_lines = [
    "# Surah An-Nur Master Landscape Mindmap",
    "## 8 Landscape Plates • 16 Thematic Pillars • 64 Detailed Analytical Cards",
    "",
...
<head>
  ...
  <title>Surah An-Nur Master Landscape Mindmap | Huurs Studio</title>
  <style>
    :root {{
      --navy-deep: #060a12;
      --navy-card: #0d1422;
...
<body>
  <div class="wrapper">
    <header class="header">
      <h1>HUURS STUDIO</h1>
      <span>Surah An-Nur Master Mindmap (8 Plates • 16 Pillars • 64 Cards)</span>
    </header>
